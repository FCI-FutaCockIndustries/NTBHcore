...
public abstract class TelemetryInfoScreenMixin extends Screen {
    protected TelemetryInfoScreenMixin() {
        super(null);
    }
    @Redirect(method = "render",
            at = @At(value = "INVOKE",
                    target = "Lnet/minecraft/client/gui/screen/option/TelemetryInfoScreen;renderBackgroundTexture(Lnet/minecraft/client/gui/DrawContext;)V",
                    ordinal = 0))
    public void onRender(TelemetryInfoScreen screen, DrawContext context) {
        //nothing
    }
