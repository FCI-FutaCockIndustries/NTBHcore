...
public abstract class ControlsOptionsScreenMixin extends Screen {
    ...
    @Redirect(method = "render",
            at = @At(value = "INVOKE",
                    target = "Lnet/minecraft/client/gui/screen/option/ControlsOptionsScreen;renderBackground(Lnet/minecraft/client/gui/DrawContext;)V",
                    ordinal = 0))
    public void onRender(ControlsOptionsScreen screen, DrawContext context) {
        //nothing
    }
