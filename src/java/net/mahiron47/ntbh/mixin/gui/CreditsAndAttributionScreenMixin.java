...
public abstract class CreditsAndAttributionScreenMixin extends Screen {
    protected CreditsAndAttributionScreenMixin() {
        super(null);
    }
    @Redirect(method = "render",
            at = @At(value = "INVOKE",
                    target = "Lnet/minecraft/client/gui/screen/option/CreditsAndAttributionScreen;renderBackground(Lnet/minecraft/client/gui/DrawContext;)V",
                    ordinal = 0))
    public void onRender(CreditsAndAttributionScreen screen, DrawContext context) {
        //nothing
    }
